...
export class DepthTexture {
    ...
    private depth_texture: WebGLTexture;
    private VAO: WebGLVertexArrayObject;
    private quad_VBO: WebGLBuffer;

    private texture_size: number = 4096;
    ...
    constructor(texture_size?: number) {
        gl = global.gl;
        assert(gl);
        ...
        this.depth_shader = new Shader(gl, require("shaders/depth_RTT.vert"), require("shaders/depth_RTT.frag"));
